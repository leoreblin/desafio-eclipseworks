...
namespace DesafioEclipseworks.WebAPI.Data.Migrations
{
    ...
    [Migration("20231203185018_ChangingDueDateTypeToDate")]
    partial class ChangingDueDateTypeToDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DesafioEclipseworks.WebAPI.Domain.Entities.Projects.Project", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("DesafioEclipseworks.WebAPI.Domain.Entities.Tasks.TaskEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("newsequentialid()");
            ...
            modelBuilder.Entity("DesafioEclipseworks.WebAPI.Domain.Entities.Tasks.TaskUpdateHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("newsequentialid()");
            ...
            modelBuilder.Entity("DesafioEclipseworks.WebAPI.Domain.Entities.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("newsequentialid()");
            ...
            modelBuilder.Entity("DesafioEclipseworks.WebAPI.Domain.Entities.Projects.Project", b =>
                {
                    b.HasOne("DesafioEclipseworks.WebAPI.Domain.Entities.Users.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DesafioEclipseworks.WebAPI.Domain.Entities.Tasks.TaskEntity", b =>
                {
                    b.HasOne("DesafioEclipseworks.WebAPI.Domain.Entities.Projects.Project", null)
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("DesafioEclipseworks.WebAPI.Domain.Entities.Tasks.TaskUpdateHistory", b =>
                {
                    b.HasOne("DesafioEclipseworks.WebAPI.Domain.Entities.Tasks.TaskEntity", null)
                        .WithMany()
